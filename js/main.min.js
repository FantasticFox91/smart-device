...
window.addEventListener('DOMContentLoaded', function () {
  if (document.querySelector('.accordion')) {
    ...
    document.querySelector('.footer').addEventListener('click', function (e) {
      return showAccordion(e);
    });
  }
  if (document.querySelector('[data-show-more]')) {
    document.querySelector('[data-show-more]').addEventListener('click', function (e) {
      e.preventDefault();
      if (document.querySelector('.about__text--show')) {
        document.querySelector('[data-show-more]').textContent = 'Подробнее';
        document.querySelectorAll('.about__text').forEach(function (text) {
          return text.classList.remove('about__text--show');
        });
        return;
      }
      document.querySelector('[data-show-more]').textContent = 'Скрыть';
      document.querySelectorAll('.about__text').forEach(function (text) {
        return text.classList.add('about__text--show');
      });
    });
  }
  if (document.querySelector('input[data-js="phone-number"]')) {
    var inputs = document.querySelectorAll('input[data-js="phone-number"]');
...
var showAccordion = function showAccordion(e) {
  ...
  if (e.target.classList.contains('accordion__heading')) {
    ...
    var opendAccordions = document.querySelectorAll('.accordion__heading--close');
    if (opendAccordions.length === 0) {
      accordions.forEach(function (el) {
        return el.classList.add('accordion__heading--close');
      });
      e.target.classList.toggle('accordion__heading--close');
    }
  }
};
var hideAccrodions = function hideAccrodions() {
  var accordions = document.querySelectorAll('.accordion__heading');
  accordions.forEach(function (el) {
    return el.classList.toggle('accordion__heading--close');
  });
};
var validatePhoneNumber = function validatePhoneNumber(phoneInput) {
  return phoneInput.value.length >= 18;
};
var showError = function showError(element) {
